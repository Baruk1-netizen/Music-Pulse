...
const UIController = (function() {
    ...
    return {
        ...
        createTrackDetail(img, title, artist, audio) {
            ...
            // Clear the song detail div before showing new details
            detailDiv.innerHTML = '';
...
const APPController = (function(UICtrl, APICtrl) {
    ...
    DOMInputs.tracks.addEventListener('click', async (e) => {
        ...
        // get the token
        const token = UICtrl.getStoredToken().token;
        // get the track endpoint from the clicked element
        const trackEndpoint = e.target.id;
        // get the track object from Spotify API
        ...
        // Add the track details to the UI, including audio preview
